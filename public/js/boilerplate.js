...
function generateRobomergeHeader(createSignedInUserDiv = true) {
	...
	const bigHelpButton = $('<button>')
		...
		.click(function() { window.open(helpPageURL, "_blank") })
...
function generateRobomergeFooter() {
	...
	helpButton.click(function() { window.open(helpPageURL, "_blank") })
	...
	contactButton.click(function() { window.open('/contact', "_blank") })
...
$(async () => {
	helpPageURL = await $.get('/helpPageURL')
})
