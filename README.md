...
|`blockAssetReconsider`     |n |`[]`        | |Reject reconsider requests containing assets to these targets   | |
|`graphFilteredEdges`       |n |`[]`        | |By default these edges will not be displayed on the graph  | |
